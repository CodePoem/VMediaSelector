...
public class SpacesItemDecoration extends RecyclerView.ItemDecoration {
    ...
    @Override
    public void getItemOffsets(Rect outRect, View view, final RecyclerView parent,
        ...
        if (params instanceof GridLayoutManager.LayoutParams) {
            ...
            if ((position == 0 || mOldItemCount != sumCount) && mSpanCount > 1) {
                ...
                for (int tempPosition = sumCount - mSpanCount; tempPosition < sumCount; tempPosition++) {
                    spanIndex =
                            ((GridLayoutManager) parent.getLayoutManager()).getSpanSizeLookup().getSpanIndex(tempPosition, mSpanCount);
            ...
            spanSize = ((StaggeredGridLayoutManager.LayoutParams) params).isFullSpan() ?
                    mSpanCount : 1;
